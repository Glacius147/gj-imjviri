...
global.list_item[28] = string(obj_gel);
global.list_item[29] = string(obj_bloc_metal);
global.list_item[30] = string(obj_bloc_piques);
global.list_item[31] = string(obj_bloc_statue);
global.list_item[32] = string(obj_bloc_torche);
